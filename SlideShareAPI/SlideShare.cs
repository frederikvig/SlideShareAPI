...
namespace SlideShareAPI
{
    public class SlideShare
    {
        ...
        public SlideShare(string apiKey, string sharedSecret)
        {
            ...
            this.timestamp = Convert.ToInt32(Math.Floor((DateTime.UtcNow - new DateTime(1970, 1, 1, 0, 0, 0)).TotalSeconds)).ToString();
        }
        ...
        private Dictionary<string, object> GetParameterBase()
        {
            ...
            parameterBase.Add("api_key", this.api_key);
            parameterBase.Add("ts", this.timestamp);
            parameterBase.Add("hash", Helper.CalculateSHA1(this.shared_secret + this.timestamp, Encoding.UTF8));
